						...
						<div className="relative flex h-16 justify-between">
							<div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
								...
								<Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-white">
									...
									{open ? (
										<XMarkIcon className="h-8 w-8 font-medium text-white cursor-pointer hover:text-indigo-500" aria-hidden="true" />
									) : (
										<Bars3Icon className="h-8 w-8 font-medium text-white cursor-pointer hover:text-indigo-500" aria-hidden="true" />
									)}
								</Disclosure.Button>
							</div>
								...
								<Menu as="div" className="relative ml-3">
									<div>
										<Menu.Button className="rounded-md px-2 py-2 text-sm font-semibold text-white shadow-sm">
											<GlobeAltIcon className="h-8 w-8 font-medium text-white cursor-pointer hover:text-indigo-500" aria-hidden="true" />
										</Menu.Button>
									</div>
									<Transition
										as={Fragment}
