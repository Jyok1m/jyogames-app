export default async function RuleSet() {
  return (
    <div>
      ...
      <div className="overflow-scroll text-left text-white">
        <div className="my-5">
          <h3 className="text-center text-2xl font-bold text-white mb-2.5">
            Objective
          </h3>
          <p className="mb-1">
            The objective of the Memory Game is to find all pairs of matching
            cards.
          </p>
        </div>
        <div className="mb-1">
          ...
          <ol>
            ...
            <li className="mb-1">
              If the cards match, you score 100 points and go again.
            </li>
            <li className="mb-1">
              If the cards do not match, you lose 25 points.
            </li>
